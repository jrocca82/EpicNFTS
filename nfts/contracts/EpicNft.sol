...
contract EpicNft is ERC721URIStorage {
  ...
  string[] firstWords = ["Gross", "Ugly", "Weird", "Hefty", "Teensy", "Juicy"];
  string[] secondWords = ["Noodle", "Pizza", "Hamburger", "Milkshake", "Sushi", "Cookie"];
  string[] thirdWords = ["Penguin", "Horse", "Giraffe", "Hippo", "Dinosaur", "Sloth"];
